...
ActiveRecord::Schema.define(version: 20160722091130) do
  ...
  create_table "spree_post_relations", force: :cascade do |t|
  ...
  create_table "spree_posts_tags", force: :cascade do |t|
    t.integer "post_id", null: false
  ...
  create_table "spree_products", force: :cascade do |t|
    ...
    t.string   "country_of_manufactur"
  end
