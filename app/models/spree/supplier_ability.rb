  ...
  class SupplierAbility
    ...
    def initialize(user)
      ...
      if user.supplier
        ...
        can [:admin, :update, :edit, :manage], Spree::Image do |image|
        ...
        if SpreeMarketplace::Engine.spree_related_products_available?
          ...
          can [:admin, :manage, :stock], Spree::Relation do |relation|
        ...
        can [:admin, :create, :index, :update, :read], Spree::Product
        ...
        #end
        #can [:admin, :index, :update, :create,:read], Spree::Property
        #can [:admin, :update, :create, :index, :read], Spree::Prototype
        can [:admin, :manage, :read], Spree::OptionType
